...
urlpatterns = [
    ...
    path('database/', views.database_view, name='database'),path('exporter-pdf/<path:ioc_value>/', views.exporter_pdf_view, name='exporter_pdf'),
    ...
    path('menace/confirmer/<path:ioc_value>/', views.confirmer_menace_view, name='confirmer_menace'),
